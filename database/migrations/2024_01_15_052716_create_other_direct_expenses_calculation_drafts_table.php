...
return new class extends Migration
{
    ...
    {
        Schema::create('other_direct_expenses_calculation_drafts', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('other_direct_expense_id')
                ...
                ->onDelete('cascade')
                ->name('fk_other_direct_exp_calc_draft_other_direct_exp_id'); // Set your custom constraint name here
        });
    }
