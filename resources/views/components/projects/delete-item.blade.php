<div wire:ignore.self class="modal fade theme-modal delete-modal" id="delete_item_project" tabindex="-1" aria-labelledby="delete_projectLabel" aria-hidden="true">
        ...
        <form action="#" class="theme-form">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-center flex-wrap flex-md-nowrap gap-3 gap-md-0">
                    ...
                    <a wire:click="deleteProjecthierarchal" class="btn btn-primary order-1 order-md-2" wire:loading.attr="disabled">Delete item</a>
                </div>
            </div>
        </form>
    </div>
