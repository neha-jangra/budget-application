<div wire:ignore.self class="modal fade theme-modal delete-modal" id="delete_lineItem_employee" tabindex="-1" aria-labelledby="delete_lineItemLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <h6 class="text-gray-800 text-xl font-semibold text-center mb-2">Are you sure to delete this employee?</h6>
                        <p class="text-gray-500 text-sm font-regular text-center mb-0">Are you sure you want to delete this employee?<br>This action cannot be undone.</p>
                    </div>
                </div>
