<div wire:ignore.self class="modal fade theme-modal edit-other-direct-expenses" id="edit_other_direct_expenses"
    tabindex="-1" aria-labelledby="edit_other_direct_expenses" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form method="post" class="theme-form other-direct-expenses-form" wire:submit.prevent="roleStore">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title text-primary-500 text-lg font-semibold" id="edit_other_direct_expensesLabel">
                        Edit other direct expense </h1>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-12">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                wire:model="name" autocomplete="name" autofocus value='{{ $name }}'>
                            @error('name')
                        ...
                        <div class="col-md-12">
                            <div class="form-check my-3">
                                <input class="form-check-input" type="checkbox" name="is_overhead" id="is_overhead"
                                    wire:model="is_overhead" {{ $is_overhead ? 'checked' : '' }}>
                            ...
                            <div class="form-check my-3">
                                <input class="form-check-input" type="checkbox" name="is_project" id="is_project"
                                    wire:model="is_project" {{ $is_project ? 'checked' : '' }}>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary theme-btn"
                        wire:click.prevent="updateOtherDirectExpense">Save changes</button>
                </div>
            </div>
        </form>
    </div>
