<div>
    <div class="page-header">
        ...
        <h6 class="text-gray-800 h6 font-medium mb-4">Edit Donor</h6>
    </div>
    <div class="content withSideSpacing">
        <form class="theme-form-card theme-form" method="post" wire:submit.prevent="edit">
            <div class="form-field-container">
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <div wire:ignore>
                            <select
                                ...
                                <option value="{{ $donor->account_id }}" @if($donorId==$donor->exact_id)
                                    selected
                                    @endif>{{ $donor->account_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        @error('name')
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input id="organization" type="text" class="form-control @error('company_name') is-invalid @enderror" wire:model="company_name" placeholder="Company Name" autocomplete="organization" autofocus>
                        @error('company_name')
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div wire:ignore>
                            <input id="phone" type="tel" class="form-control donor_create_phone w-100" wire:model="phone_number" placeholder="1231231234" autocomplete="donor_phone_number" autofocus wire:keydown.escape="updateOldPhoneNumber" wire:blur="updateOldPhoneNumber">
                        </div>
                    </div>
                    <div class="col-lg-6 mb-3">
                        <label class="theme-form-label">Email<span
                                class="required">*</span></label>
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" wire:model="email" placeholder="olivia@testmail.com" autocomplete="email" autofocus>
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            {{ $message }}
                        </span>
                        ...
                        <div class="row gap-1 gap-md-0">
                            <div class="col-md-4">
                                <label class="radio-btn-container" for="flexRadioDefault1">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="gender"  value="male" wire:model="gender"  id="flexRadioDefault1" checked>
                            ...
                            <div class="col-md-4">
                                <label class="radio-btn-container" for="flexRadioDefault2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="gender"  value="female" wire:model="gender"  id="flexRadioDefault2">
                            ...
                            <div class="col-md-4">
                                <label class="radio-btn-container" for="flexRadioDefault3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="gender"  value="other" wire:model="gender"  id="flexRadioDefault3">
            ...
            <div class="col-lg-12 col-xl-12 mb-3">
                ...
                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" wire:model="address" placeholder="Address" autocomplete="address" autofocus>
                @error('address')
                <span class="invalid-feedback" role="alert">
                    {{ $message }}
                </span>
            ...
            <div class="col-lg-6 mb-3">
                ...
                <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" wire:model="city" placeholder="City" autocomplete="city" autofocus>
                @error('city')
                <span class="invalid-feedback" role="alert">
                    {{ $message }}
                </span>
            ...
            <div class="col-lg-6 mb-3">
                ...
                <input id="state" type="text" class="form-control @error('state') is-invalid @enderror" wire:model="state" placeholder="State" autocomplete="state" autofocus>
                @error('state')
                <span class="invalid-feedback" role="alert">
                    {{ $message }}
                </span>
            ...
            <!-- <div class="col-lg-6 mb-3">
                        ...
                        <input id="pin_code" type="text" class="form-control @error('pin_code') is-invalid @enderror" wire:model="pin_code" placeholder="Pin Code" autocomplete="pin_code" autofocus>
                        @error('pin_code')
                        <span class="invalid-feedback" role="alert">
                            {{ $message }}
                        </span>
...
<div class="form-actions d-flex justify-content-md-between flex-wrap flex-md-nowrap gap-2 gap-md-0">
    <div class="d-flex algin-items-center flex-wrap flex-md-nowrap gap-3 gap-md-0 order-1 order-md-2 ms-auto">
        <a href="{{route('donor.index')}}" class="btn btn-secondary theme-btn me-12 order-2 order-md-1">Cancel</a>
        <button type="submit" class="btn btn-primary theme-btn order-1 order-md-2">Save changes</button>
    </div>
    <a data-bs-toggle="modal" wire:click.prevent="confirmDelete({{ $donor_id }})" href="#delete_donor" class="btn btn-secondary theme-btn btn-delete order-2 order-md-1">Delete</a>
</div>
</form>
</div>
