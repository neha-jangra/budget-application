<div>
    <div class="main-content" role="main">
        <div class="page-header">
            <a href="{{ route('project.show', ['project' => $projectdetail->id]) }}" class="theme-link mb-3">
            ...
            <h6 class="text-gray-800 h6 font-medium mb-4">Edit Project</h6>
            @if (session('success'))
        ...
        <div class="content withSideSpacing">
            <form class="theme-form-card theme-form" wire:submit.prevent="store" method="post" id="create_project">
                    ...
                    <div class="row align-items-top">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input id="project_name" type="text"
                                ...
                                wire:model="project_name" value="{{ $projectdetail->project_name }}"
                                placeholder="Project P-1" autocomplete="project_name" autofocus>
                            @error('project_name')
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="input-addon right">
                                <input id="budget" type="text"
                                    ...
                                    placeholder="1.000.000,00" wire:model="budget" autocomplete="budget" autofocus
                                    data-type="currency">
                                @error('budget')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="input-addon right">
                                <input id="indirect-rate" type="text"
                                    ...
                                    wire:model="indirect_rate" autocomplete="indirect-rate" value="{{ $projectdetail->indirect_rate }}" min="1" autofocus>
                                @error('indirect_rate')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="col-lg-6 mb-3" wire:ignore>
                            ...
                            <select class="form-control  select2ww edit-donot-phone" wire:model="project_donor_id"
                                data-placeholder="Select project donor" id="project_create_user">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text"
                                ...
                                wire:model="donor_contact_name" placeholder="Dominik"
                                autocomplete="donor_contact_name" autofocus>
                        ...
                        <div class="col-lg-12 col-xl-6 mb-3">
                            <div>
                                ...
                                <input type="text" class="form-control" wire:model="donor_contract_number"
                                    placeholder="Contract Number" autocomplete="donor_contract_number" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 mb-3">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-addon right date datepicker2 datepicker_project_duration_from">
                                        <span class="add-on">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="input-addon right date right datepicker2 datepicker_project_duration_to">
                                        <span class="add-on">
                                            <img src="/images/icons/calendar-icon.svg">
                                        </span>
                                        <input wire:model="project_duration_to" type="text"
                        ...
                        <div class="col-xl-6 mb-3">
                            <div class="row">
                                <div class="col-6">
                                    <label class="theme-form-label">Current Budget Timeline (From)<span
                                            class="required">*</span></label>
                                    <div
                                        class="input-addon right date datepicker2 date_pickercurrent_budget_timeline_from">
                                        <span class="add-on">
                                            <img src="/images/icons/calendar-icon.svg">
                                        </span>
                                        <input id="current_budget_timeline_from" type="text"
                                            class="form-control @error('current_budget_timeline_from') is-invalid @enderror datepicker2 date_pickercurrent_budget_timeline_from"
                                            wire:model="current_budget_timeline_from" autocomplete="off"
                                ...
                                <div class="col-6">
                                    <label class="theme-form-label">To<span class="required">*</span></label>
                                    <div
                                        class="input-addon right date datepicker2 date_picker_current_budget_timeline_to">
                                        <span class="add-on">
                                            <img src="/images/icons/calendar-icon.svg">
                                        </span>
                                        <input id="current_budget_timeline_to" type="text"
                                            class="form-control @error('current_budget_timeline_to') is-invalid @enderror datepicker2 date_picker_current_budget_timeline_to"
                                            wire:model="current_budget_timeline_to" autocomplete="off"
                                            data-provide="datepicker" data-date-autoclose="true"
                                            data-date-format="dd-mm-yyyy" data-date-today-highlight="true"
                                            onchange="this.dispatchEvent(new InputEvent('input'))"
                                            placeholder="dd-mm-yyyy">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div wire:ignore>
                                <label class="theme-form-label">Confirmed W Finance</label>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="input-addon right date datepicker2 date_revised_datepicker">
                                ...
                                <input id="date_revised" type="text"
                                    class="form-control datepicker2 date_revised_datepicker" wire:model="date_revised"
                                    autocomplete="off" data-provide="datepicker" data-date-autoclose="true"
                                    data-date-format="dd-mm-yyyy" data-date-today-highlight="true"
                                    onchange="this.dispatchEvent(new InputEvent('input'))" placeholder="dd-mm-yyyy">
                                @error('date_revised')
                        ...
                        <div class="col-lg-6 mb-3">
                            <div wire:ignore>
                                <label class="theme-form-label ">Status</label>
                                <select id="status"
                                    class="js-example-basic-single form-control select-project-type-create @error('status') is-invalid @enderror"
                                    wire:model="status" data-minimum-results-for-search="Infinity"
                                    ...
                                    <div data-year="{{ $year }}">
                                        ...
                                        <div wire:ignore>
                                            <select id="select-{{ $year }}"
                                                class="js-example-basic-single form-control donor_select2 selectProjectCodeJs"
                ...
                <div class="form-actions d-flex justify-content-sm-end flex-wrap flex-sm-nowrap gap-3 gap-sm-0">
                    ...
                    <button type="submit" class="btn btn-primary theme-btn order-1 order-sm-2">Save changes</button>
                </div>
            </form>
        </div>
    </div>
