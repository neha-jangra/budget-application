<div>
    <div class="page-header">
        <a href="/line-item?active_tab=tab2" class="theme-link mb-3">
            ...
            <span>Back to all sub-grantee</span>
        </a>
        <h6 class="text-gray-800 h6 font-medium mb-4">Edit Sub-grantee</h6>
    </div>
    <div class="content withSideSpacing">
        <form class="theme-form-card theme-form" method="post" wire:submit.prevent="edit">
            ...
            <div class="form-actions d-flex justify-content-md-between flex-wrap flex-md-nowrap gap-2 gap-md-0">
                ...
                <a  wire:click.prevent="confirmDelete({{$user_id}})" data-bs-toggle="modal" data-bs-target="#delete_lineItem_sub_grantee" class="btn btn-secondary theme-btn btn-delete order-2 order-md-1">Delete</a>
            </div>
        </form>
    </div>
