...
use App\Models\{User, LineItemDailyRate};
...
class Edit extends Component
{
    ...
    public $company, $first_name, $last_name, $phone_number, $email, $loader = false, $country, $rate, $userdetail, $user_id, $user_country, $type_name, $lineitem_id, $country_rate = 'eur', $rate_applicable_from, $userDailyRate, $userExists, $checkEmail=true;
    ...
    {
        $this->user_id                    = Route::current()->parameter('consultant');
    ...
    public function edit()
    {
        ...
        $this->toastMessage('Success!', 'Consultant updated Successfully!', '/line-item?active_tab=tab1', 'success');
    }
    ...
    public function delete()
    {
        ...
        try {
            ...
            if ($subProjectdata) {
                $this->emit('commonModal', 'delete_lineItem_consultant');

                $this->toastMessage('Error!', 'Consultant can not be deleted, as it is already allocated on a project.', '', 'error');
            ...
            $this->toastMessage('Success!', 'Consultant Deleted Successfully!', '/line-item?active_tab=tab1', 'success');
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.lineitem.consultant.edit');
    }
}
